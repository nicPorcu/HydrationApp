...
import com.example.per6.hydrationapp.LeaderboardFragment.LeaderboardFragment.OnListFragmentInteractionListener;
import com.example.per6.hydrationapp.LeaderboardFragment.LeaderboardDisplayerContent.leaderboardDisplayerItem;
...
public class MyFragmentLeaderboardRecyclerViewAdapter extends RecyclerView.Adapter<MyFragmentLeaderboardRecyclerViewAdapter.ViewHolder> {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.fragment_fragment_leaderboard, parent, false);
